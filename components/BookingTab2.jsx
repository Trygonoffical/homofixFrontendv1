                ...
                <div className='bg-gray-100 p-2 mb-2'>
                  ...
                  <div className='pt-2'>
                    <ul  style={{paddingLeft: 'initial'}}>
                        ...
                        <li className='flex justify-between '> <span className='p-2 text-sm'>Scheduled </span><span className='p-2 text-sm'>{formatDateTime(booking.booking_date)} at {getSlotTime(booking.slot)} </span></li>
                        {/* <li className='flex justify-between '> <span className='p-2 text-sm'>Scheduled Slot</span><span className='p-2 text-sm'>{booking.slot} </span></li> */}
                        <hr />
