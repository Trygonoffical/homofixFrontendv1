                                            ...
                                            <div className="p-6">
                                                ...
                                                <div className="mt-6 pt-6 border-t border-gray-200">
                                                    <div className="bg-amber-50 rounded-xl p-4 border border-amber-200">
                                                        <div className="md:flex block items-center justify-around text-center">
                                                            ...
                                                            <div className="flex items-center justify-center text-center mt-3 md:mt-0" >
                                                                ...
                                                                <span className="text-sm text-amber-800">
                                                                    <span className="font-medium">For Chat Support :</span>
                                                                    <br />
                                                                    <a href="https://wa.me/918800855760" target="_blank" rel="noopener noreferrer" className="text-amber-900 font-semibold hover:text-amber-700 transition-colors duration-200">
                                                                        +91-88-00-855-760
                                                                    </a>
                                                                </span>
                                                            </div>
